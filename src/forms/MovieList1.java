...
public final class MovieList1 extends JFrame implements ActionListener, KeyListener, TableGUI, MenuNavigation {
    ...
    private final SearchMovie search = new SearchMovie(db.showMovieList(movieGenre));


    public MovieList1() throws SQLException, FileNotFoundException {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == cbGenres) {
            ...
            search.setGenre(Objects.requireNonNull(cbGenres.getSelectedItem()).toString());
    ...
    public void keyReleased(KeyEvent e) {
        ...
        search.setTitle(txtMovieTitle.getText());
